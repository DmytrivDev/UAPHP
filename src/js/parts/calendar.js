var addToCalendarButtons = document.querySelectorAll('.card__add');
...
addToCalendarButtons.forEach(function (button) {
  button.addEventListener('click', function () {
    ...
    var startDateFormatted = formatDateToGoogle(startDate) + 'T' + startTime.replace(':', '') + '00'; // YYYYMMDDTHHmmss
